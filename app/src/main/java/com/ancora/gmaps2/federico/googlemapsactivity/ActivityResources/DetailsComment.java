...
import com.ancora.gmaps2.federico.googlemapsactivity.models.CircleTransform;
...
public class DetailsComment extends AppCompatActivity implements  MyService.Callbacks, CommentFragment.OnFragmentInteractionListener {
    ...
    public ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            myService.registerClient(DetailsComment.this);
        ...
        public void onServiceDisconnected(ComponentName arg0) {
            Toast.makeText(DetailsComment.this, "onServiceDisconnected called", Toast.LENGTH_SHORT).show();
                            ...
                            public void run() {
                                ...
                                v.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        Intent i=new Intent(DetailsComment.this, FullScreenViewActivity.class);
    ...
    public void binding () {
        Intent intent = new Intent(DetailsComment.this, MyService.class);
    ...
    public void getList(LinkedList<String> a) {
        Toast.makeText(DetailsComment.this, "getList", Toast.LENGTH_SHORT).show();
    }
    ...
    private class WriteComment extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            AccountUser ac=new AccountUser(DetailsComment.this);
    ...
    private class Rate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            super.onPostExecute(aVoid);
            final Dialog dialog1 = new Dialog(DetailsComment.this);
    ...
    private class ConnectAsyncTask extends AsyncTask<Void, Void, Bundle> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialog = new ProgressDialog(DetailsComment.this);
    ...
    private void load(Bundle result) {
        Intent i = new Intent(DetailsComment.this, GoogleActivityNavigation.class);
        i.putExtras(result);
        startActivity(i);
        finish();
    }
